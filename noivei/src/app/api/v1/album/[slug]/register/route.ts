...
export async function POST(req: Request, { params }: RouteContext) {
  try {
    ...
    // Cadastro só é aceito NO dia do casamento — sem isso, alguém poderia se
    // cadastrar dias antes e só descobrir na hora do upload (POST photos, que
    // faz a mesma checagem) que não vai conseguir postar nada.
